...
f.rint(cid1)       = sqrt((csclx1*cscly1*csclz1)*sum(cvals1.^2.*ww0, 'all'));
f.vmax(cid1)       = max(abs(cvals1(:)));
...
f.rint(cid2)       = sqrt((csclx2*cscly2*csclz2)*sum(cvals2.^2.*ww0, 'all'));
f.vmax(cid2)       = max(abs(cvals2(:)));
...
f.rint(cid3)       = sqrt((csclx3*cscly3*csclz3)*sum(cvals3.^2.*ww0, 'all'));
f.vmax(cid3)       = max(abs(cvals3(:)));
...
f.rint(cid4)       = sqrt((csclx4*cscly4*csclz4)*sum(cvals4.^2.*ww0, 'all'));
f.vmax(cid4)       = max(abs(cvals4(:)));
...
f.rint(cid5)       = sqrt((csclx5*cscly5*csclz5)*sum(cvals5.^2.*ww0, 'all'));
f.vmax(cid5)       = max(abs(cvals5(:)));
...
f.rint(cid6)       = sqrt((csclx6*cscly6*csclz6)*sum(cvals6.^2.*ww0, 'all'));
f.vmax(cid6)       = max(abs(cvals6(:)));
...
f.rint(cid7)       = sqrt((csclx7*cscly7*csclz7)*sum(cvals7.^2.*ww0, 'all'));
f.vmax(cid7)       = max(abs(cvals7(:)));
...
f.rint(cid8)       = sqrt((csclx8*cscly8*csclz8)*sum(cvals8.^2.*ww0, 'all'));
f.vmax(cid8)       = max(abs(cvals8(:)));
