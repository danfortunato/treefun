...
cvals1             = reshape(cvals1,[nalias nalias nalias size(cvals1,2)]); % additional for nd
...
cvals2             = reshape(cvals2,[nalias nalias nalias size(cvals2,2)]); % additional for nd
...
cvals3             = reshape(cvals3,[nalias nalias nalias size(cvals3,2)]); % additional for nd
...
cvals4             = reshape(cvals4,[nalias nalias nalias size(cvals4,2)]); % additional for nd
...
cvals5             = reshape(cvals5,[nalias nalias nalias size(cvals5,2)]); % additional for nd
...
cvals6             = reshape(cvals6,[nalias nalias nalias size(cvals6,2)]); % additional for nd
...
cvals7             = reshape(cvals7,[nalias nalias nalias size(cvals7,2)]); % additional for nd
...
cvals8             = reshape(cvals8,[nalias nalias nalias size(cvals8,2)]); % additional for nd
